    ...
    <section className="py-10  ">
      <div className=" w-mobile md:w-container_width mx-auto grid md:grid-cols-2 gap-4   ">
        ...
        <div className=" p-4  space-y-7 ">
          ...
          <p>
            Metro Safaris is an indigenous tour operator in South Sudan. Our
            expertise in local demographics, tribal groups, physical topography
            and national parks in South Sudan makes us the preferred company.
            Our company is wholly owned and operated exclusively by South
            Sudanese, hence making us not only cheaper but also making your
            contribution towards supporting responsible tourism meaningful.
          </p>
          <p>
            You are making history by being among the first few tourists who
            have paid a visit to South Sudan. And we are here to make it
            mesmerizing and memorable for you! Whether you are visiting South
            Sudan for just one day or for several weeks, we can provide the best
            itinerary that suits your schedule at the most affordable price.
          </p>
          {/* <p>
